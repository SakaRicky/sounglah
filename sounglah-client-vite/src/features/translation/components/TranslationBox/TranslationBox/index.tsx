...
import { InputTextZone } from '../../InputTextZone/InputText';
import AppButton from '@/components/atoms/Button/Button';
import { RightArrow } from '@/components/Arrows';
import { OutTextZone } from '../../OutTextZone/OutTextZone';
import useTypeWriter from '@/features/translation/hooks/useTypeWriter';
import { 
...
export const TranslationBox = () => {
    ...
    // React Query hooks
    const { data: detectedLangCode, isLoading: isDetecting } = useLanguageDetection(sourceText);
